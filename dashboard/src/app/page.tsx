...
import { FileText, AlertTriangle, CheckCircle, XCircle, Clock, ExternalLink, Search } from 'lucide-react'
...
export default function Dashboard() {
  ...
  async function cargarDatos() {
    ...
    for (const ant of (antecedentes || [])) {
      ...
      // Guardar solo el más reciente por fuente
  ...
  // Contadores de alertas globales
              ...
              <div key={p.cedula} className="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden">
                ...
                {abierto && (
                  <div className="border-t border-gray-800 px-4 py-4 space-y-4">
                    ...
                    {p.aportes.length > 0 && (
                      <div>
                        <h3 className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Aportes</h3>
                          ...
                          <table className="w-full text-sm">
                            <thead>
                              <tr className="text-xs text-gray-500 border-b border-gray-800">
                                ...
                                <th className="text-left pb-2">PDF</th>
                              </tr>
                            </thead>
                            <tbody>
                              {p.aportes.map(a => (
