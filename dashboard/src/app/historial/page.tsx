    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <div className="bg-emerald-50 border border-emerald-200 dark:bg-emerald-500/10 dark:border-emerald-500/25 rounded-xl p-4 flex items-center gap-3">
          ...
          <div>
            <div className="text-2xl font-bold text-emerald-800 dark:text-emerald-400">{totalAvalados}</div>
            <div className="text-xs text-emerald-700/80 dark:text-emerald-400/70 mt-0.5">Avalados</div>
          </div>
        </div>
        <div className="bg-red-50 border border-red-200 dark:bg-red-500/10 dark:border-red-500/25 rounded-xl p-4 flex items-center gap-3">
          ...
          <div>
            <div className="text-2xl font-bold text-red-800 dark:text-red-400">{totalRechazados}</div>
            <div className="text-xs text-red-700/80 dark:text-red-400/70 mt-0.5">Rechazados</div>
          </div>
        </div>
        <div className="bg-amber-50 border border-amber-200 dark:bg-amber-500/10 dark:border-amber-500/25 rounded-xl p-4 flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-xs text-amber-700/80 dark:text-amber-400/70 mt-0.5">Pendientes</div>
          </div>
        </div>
        <div className="bg-blue-50 border border-blue-200 dark:bg-blue-500/10 dark:border-blue-500/25 rounded-xl p-4 flex items-center gap-3">
          <div className="w-9 h-9 rounded-lg bg-blue-100 dark:bg-blue-500/20 flex items-center justify-center shrink-0">
            <DollarSign className="w-5 h-5 text-blue-600 dark:text-blue-400" />
          </div>
          <div>
            <div className="text-xl font-bold text-blue-800 dark:text-blue-400">${valorAvalado.toLocaleString('es-CO')}</div>
            <div className="text-xs text-blue-700/80 dark:text-blue-400/70 mt-0.5">Valor avalado</div>
          </div>
        </div>
      </div>
